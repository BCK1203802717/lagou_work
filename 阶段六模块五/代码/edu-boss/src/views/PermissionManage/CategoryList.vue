...
export default {
  ...
  methods: {
    ...
    handleAdd() {
      ...
      this.isEdit = false;
      this.resourceCategory = Object.assign({}, resourceCategory);
    },
    ...
    handleSave() {
      axios
      .post("/resourceCategory/saveOrUpdateResourceCategory",this.resourceCategory)
      .then(res=>{
    ...
    handleDelete(index, row) {
      axios
      .get("/resourceCategory/deleteResourceCategory",{params:{
        id:row.id
      }})
      .then(res=>{
        this.getCateList();
